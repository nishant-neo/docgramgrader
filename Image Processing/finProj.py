...
path = 'C:\Users\NISHANT\Desktop\Sem 2\Project\DocGramCor\Dataset Generation\Images\\'

folders = [ f for f in listdir(path) ]
for folder in folders:
	#image reading
	image_path =  path + folder + '\\' + folder + '-1.jpg'
	...
	X = image_to_string(img)#,config='-psm 7')
	print X
	f = open('Essays/' + str(folder)+ '.txt', 'w')
	f.write(X)
	f.close()
